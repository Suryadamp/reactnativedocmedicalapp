...
const setSecureValue = (key: string, value: string): Promise<false | Keychain.Result> =>
...
const removeSecureValue = (key: string): Promise<void> => Keychain.resetInternetCredentials(key);
