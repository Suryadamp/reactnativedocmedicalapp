...
import { ICustomMedicineBottomSheetProps } from '../../@types/components';
...
const CustomMedicineBottomSheet: React.FC<ICustomMedicineBottomSheetProps> = ({
  handleClosePress,
      ...
      <Box>
        <ScrollView showsVerticalScrollIndicator={true}>
          <RadioButton.Group onValueChange={handleOptionChange} value={selectedOption}>
            {prescriptionProductList?.map((option, index) => (
              <RadioButton.Item
                mode="android"
                label={option.name}
                value={option.name}
...
export default CustomMedicineBottomSheet;
